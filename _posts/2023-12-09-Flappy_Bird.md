...
layout: post
title: flabby bird
description: Banned? Nah. A complex mix of HTML, Java, and CSS creating the esteemed and forever beloved flabpy bird game - but better.
type: tangibles
...
<style>
    ...
    #board {
        ...
        background-image: url("{{site.baseurl}}/images/flappybirdbg.png");
        text-align: "center";
    }
...
<script>
    ...
    window.onload = function() {
        ...
        //load images
        birdImg = new Image();
        birdImg.src = "{{site.baseurl}}/images/flappybird.png"; 
        birdImg.onload = function() {
            context.drawImage(birdImg, bird.x, bird.y, bird.width, bird.height);
        }

        topPipeImg = new Image();
        topPipeImg.src = "{{site.baseurl}}/images/toppipe.png"; //toppipe

        bottomPipeImg = new Image();
        bottomPipeImg.src = "{{site.baseurl}}/images/bottompipe.png"; //bottompipe
